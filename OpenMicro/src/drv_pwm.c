  ...
  switch( number)
	{
		...
		case 4: 
			#ifdef MOTOR4_PIN_PA0
			TIM2->CCR1 = (uint16_t) pwm;
			#endif
			#ifdef MOTOR4_PIN_PA1
			TIM2->CCR2 = (uint16_t) pwm;
			#endif
		  #ifdef MOTOR4_PIN_PA2
			TIM2->CCR3 = (uint16_t) pwm;
			#endif
		  #ifdef MOTOR4_PIN_PA3
			TIM2->CCR4 = (uint16_t) pwm;
			#endif
      #ifdef MOTOR4_PIN_PA4
			TIM14->CCR1 = (uint16_t) pwm;
			#endif
		  #ifdef MOTOR4_PIN_PA5
			TIM2->CCR1 = (uint16_t) pwm;
			#endif
      #ifdef MOTOR4_PIN_PA6
			TIM3->CCR1 = (uint16_t) pwm;
			#endif
      #ifdef MOTOR4_PIN_PA7
			TIM3->CCR2 = (uint16_t) pwm;
			#endif
			#ifdef MOTOR4_PIN_PA8
			TIM1->CCR1 = (uint16_t) pwm;
			#endif
			#ifdef MOTOR4_PIN_PA9
			TIM1->CCR2 = (uint16_t) pwm;
			#endif		
		  #ifdef MOTOR4_PIN_PA10
			TIM1->CCR3 = (uint16_t) pwm;
			#endif	
			#ifdef MOTOR4_PIN_PA11
			TIM1->CCR4 = (uint16_t) pwm;
      #endif
      #ifdef MOTOR4_PIN_PB0
			TIM3->CCR3 = (uint16_t) pwm;
			#endif	
      #ifdef MOTOR4_PIN_PB1
			TIM3->CCR4 = (uint16_t) pwm;
			#endif	
		break;

		case 5: 
			#ifdef MOTOR5_PIN_PA0
			TIM2->CCR1 = (uint16_t) pwm;
			#endif
			#ifdef MOTOR5_PIN_PA1
			TIM2->CCR2 = (uint16_t) pwm;
			#endif
		  #ifdef MOTOR5_PIN_PA2
			TIM2->CCR3 = (uint16_t) pwm;
			#endif
		  #ifdef MOTOR5_PIN_PA3
			TIM2->CCR4 = (uint16_t) pwm;
			#endif
      #ifdef MOTOR5_PIN_PA4
			TIM14->CCR1 = (uint16_t) pwm;
			#endif
		  #ifdef MOTOR5_PIN_PA5
			TIM2->CCR1 = (uint16_t) pwm;
			#endif
      #ifdef MOTOR5_PIN_PA6
			TIM3->CCR1 = (uint16_t) pwm;
			#endif
      #ifdef MOTOR5_PIN_PA7
			TIM3->CCR2 = (uint16_t) pwm;
			#endif
			#ifdef MOTOR5_PIN_PA8
			TIM1->CCR1 = (uint16_t) pwm;
			#endif
			#ifdef MOTOR5_PIN_PA9
			TIM1->CCR2 = (uint16_t) pwm;
			#endif		
		  #ifdef MOTOR5_PIN_PA10
			TIM1->CCR3 = (uint16_t) pwm;
			#endif	
			#ifdef MOTOR5_PIN_PA11
			TIM1->CCR4 = (uint16_t) pwm;
      #endif
      #ifdef MOTOR5_PIN_PB0
			TIM3->CCR3 = (uint16_t) pwm;
			#endif	
      #ifdef MOTOR5_PIN_PB1
			TIM3->CCR4 = (uint16_t) pwm;
			#endif	
		break;
